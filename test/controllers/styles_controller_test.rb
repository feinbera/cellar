...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { description: @style.description, name: @style.name, parent_id: @style.parent_id }
    end
  ...
  test "should update style" do
    patch :update, id: @style, style: { description: @style.description, name: @style.name, parent_id: @style.parent_id }
    assert_redirected_to style_path(assigns(:style))
  end
