...
class BreweriesControllerTest < ActionController::TestCase
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post :create, brewery: { city: @brewery.city, country: @brewery.country, name: @brewery.name, postal: @brewery.postal, state: @brewery.state }
    end
  ...
  test "should update brewery" do
    patch :update, id: @brewery, brewery: { city: @brewery.city, country: @brewery.country, name: @brewery.name, postal: @brewery.postal, state: @brewery.state }
    assert_redirected_to brewery_path(assigns(:brewery))
  end
