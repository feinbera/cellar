...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { container_id: @box.container_id, container_type: @box.container_type, flags: @box.flags, name: @box.name }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { container_id: @box.container_id, container_type: @box.container_type, flags: @box.flags, name: @box.name }
    assert_redirected_to box_path(assigns(:box))
  end
